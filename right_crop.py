...
def crop_image_from_bottom_right(input_path, output_path, new_width=300, new_height=300):
    """
    Crop an image to a specific resolution based on the bottom right corner, then save it to a new folder.
    ...
    with Image.open(input_path) as img:
        # Calculate the bottom-right point of the cropping box
        right = img.width
        bottom = img.height
        left = right - new_width
        top = bottom - new_height

        # Crop the image based on the bottom right corner
...
def process_folder(input_folder, output_folder):
    ...
    for filename in os.listdir(input_folder):
        if filename.lower().endswith(('.png', '.jpg', '.jpeg', '.bmp', '.gif', '.tiff')):
            ...
            crop_image_from_bottom_right(input_path, output_path)

# Example usage
if __name__ == "__main__":
    input_folder = 'C:/Users/Intern/Documents/Data_Collecton_Chamodya/20231211/images/0/Right Rurn'
    output_folder = 'C:/Users/Intern/Documents/Data_Collecton_Chamodya/20231211/images/0/right one'
